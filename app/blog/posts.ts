...
export const blogPosts: BlogPost[] = [
  {
    ...
    description:
      "Discover how Antigravity moves beyond simple code completion to full-scale autonomous task execution, transforming the developer workflow.",
    sections: [
      {
        heading: "Beyond Copilots",
        paragraphs: [
          "The first generation of AI coding assistants were like eager junior developers who could only type what you dictated. They were great at completing lines but struggled with context. Antigravity represents a paradigm shift: an agent capable of understanding high-level intent, planning complex executions, and verifying its own work.",
          "It's not just about writing code faster; it's about thinking at a higher level of abstraction while the agent handles the implementation details."
        ]
      },
      {
        heading: "The Agentic Workflow",
        paragraphs: [
          "Antigravity operates on a 'Think, Plan, Execute' loop. When given a task, it doesn't just guess the next token. It analyzes the codebase, formulates a multi-step plan, and executes it tool by tool. It can run terminal commands, browse the web for documentation, and even visually inspect the UI it builds.",
          "This workflow mimics a senior engineer's approach: understand the problem first, design the solution, and then—and only then—write the code."
        ],
        bullets: [
          "Autonomous Planning: Breaking down complex feature requests into actionable steps.",
          "Self-Correction: Detecting errors during execution and refining the approach without human intervention.",
          "Multimodal Understanding: processing not just code, but images and UI layouts to ensure pixel-perfect results."
        ]
      },
      {
        heading: "Collaborative Intelligence",
        paragraphs: [
          "The future isn't AI replacing developers; it's AI amplifying human creativity. Antigravity handles the 'gravity' of software development—the boilerplate, the refactoring, the bug hunting—freeing you to focus on the 'anti-gravity' aspects: architecture, user experience, and innovation.",
          "We are entering an era where one developer can do the work of a small team, not by working harder, but by orchestrating a powerful agent."
        ]
      }
    ],
    references: [
      { label: "Google DeepMind", url: "https://deepmind.google/" },
      { label: "Agentic AI Overview", url: "https://cloud.google.com/use-cases/agentic-ai" }
    ]
  },
  {
